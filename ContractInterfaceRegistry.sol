...
contract ContractInterfaceRegistry {
    ...
    /// @notice GetManager
    function getManager(address addr) public constant returns(address) {
...
interface ContractInterfaceRegistryImplementer {
    ...
    function canImplementInterfaceForAddress(address addr, bytes32 interfaceHash) external returns(bytes32);
}
